              ...
              <div className="z-10 max-w-4xl space-y-6">
                ...
                <div className="flex justify-center space-x-4 pt-6">
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 rounded-full bg-white/90 hover:bg-white shadow-lg hover:shadow-xl border border-gray-200/50 transition-all duration-300"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
